...
CREATE TABLE testx2 AS (
  WITH dates AS (
     ...
     SELECT pages.page AS page,
            ...
            pages.date AS date,
            xy2.visits AS visits_lag12,
            xy2.visits_lag1 AS visits_lag13,
            xy2.visits_lag2 AS visits_lag14,
            xy2.visits_lag3 AS visits_lag15,
            xy2.visits_lag4 AS visits_lag16,
            xy2.visits_lag5 AS visits_lag17,
            xy2.visits_lag6 AS visits_lag18,
            xy2.visits_lag7 AS visits_lag19,
            xy2.visits_lag8 AS visits_lag20,
            xy2.visits_lag9 AS visits_lag21,
            xy2.visits_lag10 AS visits_lag22,
            xy2.visits_lag11 AS visits_lag23,
            xy2.visits_lag12 AS visits_lag24,
            xy2.visits_lag13 AS visits_lag25,
            xy2.visits_lag14 AS visits_lag26,
            xy2.visits_lag15 AS visits_lag27,
            xy2.visits_lag16 AS visits_lag28,
            xy2.visits_lag17 AS visits_lag29,
            xy2.visits_lag18 AS visits_lag30,
            xy2.visits_lag19 AS visits_lag31,
            xy2.visits_lag20 AS visits_lag32,
            xy2.visits_lag21 AS visits_lag33,
            xy2.visits_lag22 AS visits_lag34,
            xy2.visits_lag23 AS visits_lag35,
            xy2.visits_lag24 AS visits_lag36,
            xy2.visits_lag25 AS visits_lag37,
            xy2.visits_lag26 AS visits_lag38,
            xy2.visits_lag27 AS visits_lag39,
            xy2.visits_lag28 AS visits_lag40,
            xy2.visits_lag29 AS visits_lag41,
            xy2.visits_lag30 AS visits_lag42,
            xy2.visits_lag31 AS visits_lag43,
            xy2.visits_lag32 AS visits_lag44,
            xy2.visits_lag33 AS visits_lag45,
            xy2.visits_lag34 AS visits_lag46,
            xy2.visits_lag35 AS visits_lag47,
            xy2.visits_lag36 AS visits_lag48,
            xy2.visits_lag37 AS visits_lag49,
            xy2.visits_lag38 AS visits_lag50,
            xy2.visits_lag39 AS visits_lag51,
            xy2.visits_lag40 AS visits_lag52,
            xy2.visits_lag41 AS visits_lag53,
            xy2.visits_lag42 AS visits_lag54,
            xy2.visits_lag43 AS visits_lag55,
            xy2.visits_lag44 AS visits_lag56,
            xy2.visits_lag45 AS visits_lag57,
            xy2.visits_lag46 AS visits_lag58,
            xy2.visits_lag47 AS visits_lag59,
            xy2.visits_lag48 AS visits_lag60,
            xy2.visits_lag49 AS visits_lag61,
            xy2.visits_lag50 AS visits_lag62,
            xy2.visits_lag51 AS visits_lag63,
            xy2.visits_lag52 AS visits_lag64,
            xy2.visits_lag53 AS visits_lag65,
            xy2.visits_lag54 AS visits_lag66,
            xy2.visits_lag55 AS visits_lag67,
            xy2.visits_lag56 AS visits_lag68,
            xy2.visits_lag57 AS visits_lag69,
            xy2.visits_lag58 AS visits_lag70,
            xy2.visits_lag59 AS visits_lag71,
            xy2.visits_lag60 AS visits_lag72,
            xy2.visits_lag61 AS visits_lag73,
            xy2.visits_lag62 AS visits_lag74,
            xy2.visits_lag63 AS visits_lag75,
            xy2.visits_lag64 AS visits_lag76,
            xy2.visits_lag65 AS visits_lag77,
            xy2.visits_lag66 AS visits_lag78,
            xy2.visits_lag67 AS visits_lag79,
            xy2.visits_lag68 AS visits_lag80,
            xy2.visits_lag69 AS visits_lag81,
            xy2.visits_lag70 AS visits_lag82,
            xy2.visits_lag71 AS visits_lag83,
            xy2.visits_lag72 AS visits_lag84,
            xy2.visits_lag73 AS visits_lag85,
            xy2.visits_lag74 AS visits_lag86,
            xy2.visits_lag75 AS visits_lag87,
            xy2.visits_lag76 AS visits_lag88,
            xy2.visits_lag77 AS visits_lag89,
            xy2.visits_lag78 AS visits_lag90,
            xy2.visits_lag79 AS visits_lag91
       FROM (SELECT page, dates.date FROM (SELECT DISTINCT page FROM train2_flat_split) a, dates) pages
  LEFT JOIN xy2 ON xy2.page=pages.page AND xy2.date=pages.date - INTERVAL '12' day
);
...
UPDATE testx2
   SET visits_lag12 = null,
         visits_lag13 = xy2.visits,
         visits_lag14 = xy2.visits_lag1,
         visits_lag15 = xy2.visits_lag2,
         visits_lag16 = xy2.visits_lag3,
         visits_lag17 = xy2.visits_lag4,
         visits_lag18 = xy2.visits_lag5,
         visits_lag19 = xy2.visits_lag6,
         visits_lag20 = xy2.visits_lag7,
         visits_lag21 = xy2.visits_lag8,
         visits_lag22 = xy2.visits_lag9,
         visits_lag23 = xy2.visits_lag10,
         visits_lag24 = xy2.visits_lag11,
         visits_lag25 = xy2.visits_lag12,
         visits_lag26 = xy2.visits_lag13,
         visits_lag27 = xy2.visits_lag14,
         visits_lag28 = xy2.visits_lag15,
         visits_lag29 = xy2.visits_lag16,
         visits_lag30 = xy2.visits_lag17,
         visits_lag31 = xy2.visits_lag18,
         visits_lag32 = xy2.visits_lag19,
         visits_lag33 = xy2.visits_lag20,
         visits_lag34 = xy2.visits_lag21,
         visits_lag35 = xy2.visits_lag22,
         visits_lag36 = xy2.visits_lag23,
         visits_lag37 = xy2.visits_lag24,
         visits_lag38 = xy2.visits_lag25,
         visits_lag39 = xy2.visits_lag26,
         visits_lag40 = xy2.visits_lag27,
         visits_lag41 = xy2.visits_lag28,
         visits_lag42 = xy2.visits_lag29,
         visits_lag43 = xy2.visits_lag30,
         visits_lag44 = xy2.visits_lag31,
         visits_lag45 = xy2.visits_lag32,
         visits_lag46 = xy2.visits_lag33,
         visits_lag47 = xy2.visits_lag34,
         visits_lag48 = xy2.visits_lag35,
         visits_lag49 = xy2.visits_lag36,
         visits_lag50 = xy2.visits_lag37,
         visits_lag51 = xy2.visits_lag38,
         visits_lag52 = xy2.visits_lag39,
         visits_lag53 = xy2.visits_lag40,
         visits_lag54 = xy2.visits_lag41,
         visits_lag55 = xy2.visits_lag42,
         visits_lag56 = xy2.visits_lag43,
         visits_lag57 = xy2.visits_lag44,
         visits_lag58 = xy2.visits_lag45,
         visits_lag59 = xy2.visits_lag46,
         visits_lag60 = xy2.visits_lag47,
         visits_lag61 = xy2.visits_lag48,
         visits_lag62 = xy2.visits_lag49,
         visits_lag63 = xy2.visits_lag50,
         visits_lag64 = xy2.visits_lag51,
         visits_lag65 = xy2.visits_lag52,
         visits_lag66 = xy2.visits_lag53,
         visits_lag67 = xy2.visits_lag54,
         visits_lag68 = xy2.visits_lag55,
         visits_lag69 = xy2.visits_lag56,
         visits_lag70 = xy2.visits_lag57,
         visits_lag71 = xy2.visits_lag58,
         visits_lag72 = xy2.visits_lag59,
         visits_lag73 = xy2.visits_lag60,
         visits_lag74 = xy2.visits_lag61,
         visits_lag75 = xy2.visits_lag62,
         visits_lag76 = xy2.visits_lag63,
         visits_lag77 = xy2.visits_lag64,
         visits_lag78 = xy2.visits_lag65
  FROM xy2
 WHERE xy2.page=testx2.page AND xy2.date=testx2.date - INTERVAL '12' day;
